...
AlTER TABLE HOADON ALTER COLUMN TongTien float NULL;
ALTER TABLE HOADON ALTER COLUMN NgayXuatDon DATE NULL;
ALTER TABLE HOADON ALTER COLUMN NgayThanhToan DATE NULL;
ALTER TABLE HOADON ALTER COLUMN Thue FLOAT NULL;